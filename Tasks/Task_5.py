...
class RadioButtonsApp:
    options = {"Рыбы": "19 февраля - 20 марта", "Козерог": "22 декабря - 19 января", "Скорпион": "23 октября - 21 ноября"}
    ...
    def __init__(self, root):
        ...
        for key in self.options:
            radio_button = tk.Radiobutton(self.radio_frame, text=key, width=10, variable=self.selected_option, value=key, indicatoron=0, command=self.update_label)
